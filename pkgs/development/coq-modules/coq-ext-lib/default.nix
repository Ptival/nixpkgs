...
let
  ...
  default-versions =
  {
    "8.5" = ext-lib-versions."0_9_4";
    "8.6" = ext-lib-versions."0_9_5";
    "8.7" = ext-lib-versions."0_9_7";
    "8.8" = ext-lib-versions."0_10_3";
    "8.9" = ext-lib-versions."0_10_3";
  };
  param =
    if version != null
    then ext-lib-versions.${version}
